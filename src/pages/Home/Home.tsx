                        ...
                        <div className={styles.lowerArea}>
                            <div className={styles.totalMenuArea}>
                                ...
                                <div className={styles.contactsBox1}>
                                    ...
                                    <a href="https://www.linkedin.com/in/thiago-razor/"> <img className={styles.iconArea} src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" alt="Linkedin" /> </a>
                                </div>
                            </div>
                        </div>
                    </div>
